...
-- ============================================================
-- Lock the limiter down. Postgres grants EXECUTE to everyone by
-- default, which would let any visitor call it with someone
-- else's bucket and lock that person out. Only the server, using
-- the service role key, should ever run these.
-- ============================================================
...
-- ============================================================
-- Belt and braces: the limiter refuses anyone who is not the
-- server. Grants alone were not enough, because Supabase hands
-- EXECUTE back to anon by default on functions in this schema.
-- ============================================================
...
begin
  -- Only the service role (the server) may touch this table.
